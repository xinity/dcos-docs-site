...
This is the process for deploying a new service:
...
This is the process for reconfiguring a DC/OS service either in order to update specific configuration values, or to upgrade it to a new package version.
...
This is the process for uninstalling DC/OS {{model.techName }}.
