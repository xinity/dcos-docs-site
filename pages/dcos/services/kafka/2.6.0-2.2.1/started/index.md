...
- Depending on your security mode in Enterprise DC/OS, you may [need to provision a service account](/dcos/services/kafka/kafka-auth/) before installing Kafka. You will need a `superuser` permission to create the service account. The following is a list of [security modes](/1.9/security/ent/#security-modes):
