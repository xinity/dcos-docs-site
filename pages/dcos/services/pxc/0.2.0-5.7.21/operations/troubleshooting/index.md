...
[Prometheus](/dcos/services/prometheus/) can be installed via either the DC/OS Catalog GUI or by using the CLI. The following command will launch the install via the DC/OS CLI:

```bash
dcos package install prometheus
```

Install [Grafana](/dcos/services/grafana/) from the service catalog as well. It can be used as a graphing tool.
```bash
dcos package install --yes grafana
```

[<img src="/services/pxc/0.2.0-5.7.21/img/prom_install.png" alt="Prometheus Install"/>](/dcos/services/pxc/0.2.0-5.7.21/img/prom_install.png)
...
[<img src="/services/pxc/0.2.0-5.7.21/img/prom_dashboard.png" alt="Prometheus Dashboard"/>](/dcos/services/pxc/0.2.0-5.7.21/img/prom_dashboard.png)
...
[<img src="/services/pxc/0.2.0-5.7.21/img/prom_graphing.png" alt="Prometheus Graphing"/>](/dcos/services/pxc/0.2.0-5.7.21/img/prom_graphing.png)
...
[<img src="/services/pxc/0.2.0-5.7.21/img/grafana_login.png" alt="Grafana Logging"/>](/dcos/services/pxc/0.2.0-5.7.21/img/grafana_login.png)
...
[<img src="/services/pxc/0.2.0-5.7.21/img/grafana_datasource.png" alt="Grafana Data Source"/>](/dcos/services/pxc/0.2.0-5.7.21/img/grafana_datasource.png)
...
[<img src="/services/pxc/0.2.0-5.7.21/img/grafana_prom.png" alt="Grafana Prom Graph"/>](/dcos/services/pxc/0.2.0-5.7.21/img/grafana_prom.png)
