...
- The [DC/OS Enterprise CLI is installed](/dcos/1.12/cli/enterprise-cli/).
...
- Edge-LB supports all [security modes](/dcos/1.12/security/ent/#security-modes) in DC/OS 1.11 and later. It supports Permissive, Disabled in DC/OS 1.10. DC/OS 1.9 or earlier is not supported.
...
The steps below require [DC/OS Enterprise CLI to be installed](/dcos/1.12/cli/enterprise-cli/#installing-the-dcos-enterprise-cli)
...
Use the following CLI commands to provision the Edge-LB service account with the required permissions. All CLI commands can also be executed via the [IAM API](/dcos/1.12/security/ent/iam-api/).
...
For more information about required permissions, please see the [Edge-LB Permissions](/dcos/services/edge-lb/1.2/permissions/)
...
* `service.name`: `"dcos-edgelb/api"`. The service path for the `apiserver`. `dcos-edgelb` corresponds to `pool.namespace` when [configuring pools](/dcos/services/edge-lb/1.2/pool-configuration/).
...
- For more information about configuring Edge-LB, see the [Edge-LB Configuration](/dcos/services/edge-lb/1.2/pool-configuration/) section.
- For more information about the available Edge-LB commands, see the [Edge-LB Command Reference](/dcos/services/edge-lb/1.2/cli-reference/).
