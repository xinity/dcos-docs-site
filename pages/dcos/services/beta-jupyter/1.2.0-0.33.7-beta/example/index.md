...
To learn more about HDFS or advanced HDFS installation options, see the [HDFS service documentation](/dcos/services/hdfs/).

## Marathon-LB

To expose {{ model.techShortName }} externally, install [Marathon-LB](/dcos/services/marathon-lb/) using the following command:

```bash
$ dcos package install marathon-lb
```
To learn more about Marathon-LB or advanced Marathon-LB installation options, see the [Marathon-LB documentation](/dcos/services/marathon-lb/).
...
1. Expose the service on a [public agent](https://docs.mesosphere.com/latest/overview/architecture/node-types/) by changing the `networking.external_access.external_public_agent_hostname` setting to an externally reachable virtual host (`VHOST`).
  ...
  [<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-VHOST_UI.png" alt="VHOST configuration" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-VHOST_UI.png)
...
1. Specify the configuration file URLs.
  ...
  [<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-hdfs_ui.png" alt="HDFS configuration" width="400"/>](/dcos/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-hdfs_ui.png)
...
1. Install {{ model.techShortName }} either by clicking **Run Service** in the DC/OS web-based interface or from the CLI.
  ...
  [<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-install_ui.png" alt="Run service" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-install_ui.png)
  ...
  For more information about the options for installing {{ model.techShortName }}, see [installation](/dcos/services/beta-jupyter/installing/).
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-login.png" alt="{{ model.techShortName }} login" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-login.png)

Figure 4. {{ model.techShortName }} login

The default password with the above settings is `jupyter`.

[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-jupyterlab_ui.png" alt="Default password {{ model.techPassword }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-jupyterlab_ui.png)
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-sparkPi.png" alt="SparkPi on {{ model.techShortName }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-sparkPi.png)
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-SparkPi_Mesos.png" alt="SparkPi Mesos on {{ model.techShortName }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-SparkPi_Mesos.png)
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-SparkPi_Toree.png" alt="SparkPiToree on {{ model.techShortName }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-SparkPi_Toree.png)
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-gpu.png" alt="GPU on {{ model.techShortName }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-gpu.png)
...
[<img src="/services/beta-jupyter/1.2.0-0.33.7-beta/img/jupyterlab-TensorBoard.png" alt="TensorBoard on {{ model.techShortName }}" width="400"/>](/dcos/services/beta-jupyter/img/jupyterlab-TensorBoard.png)    
