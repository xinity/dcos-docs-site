...
This topic describes how to configure DC/OS access for Spark. Depending on your [security mode](/dcos/1.12/security/ent/#security-modes/), Spark requires [service authentication](/dcos/1.12/security/ent/service-auth/) for access to DC/OS.
...
- If your [security mode](/dcos/1.12/security/ent/#security-modes/) is `permissive` or `strict`, you must [get the root cert](/1.9/networking/tls-ssl/get-cert/) before issuing the curl commands in this section.
