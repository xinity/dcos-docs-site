...
When running in [DC/OS strict security mode](https://docs.mesosphere.com/latest/security/ent/#security-modes), both the dispatcher and jobs must authenticate to Mesos using a [DC/OS service account](/dcos/services/spark/2.8.0-2.4.0/security/#provision-a-service-account).
...
When running in [DC/OS strict security mode](/dcos/1.12/security/ent/#security-modes/), both the dispatcher and jobs must authenticate to Mesos using a [DC/OS service account](/dcos/1.12/security/ent/#service/).
