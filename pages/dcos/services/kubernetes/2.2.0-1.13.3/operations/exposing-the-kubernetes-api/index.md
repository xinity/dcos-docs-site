...
Alternately, if you are running Marathon-LB and/or Edge-LB in your DC/OS cluster, you may wish to expose the Kubernetes API for a given Kubernetes cluster via one of those. Details on how to do this are documented [here](/dcos/services/kubernetes/2.2.0-1.13.3/operations/exposing-the-kubernetes-api-marathonlb-edgelb/).
...
![Exposing the Kubernetes API using HAProxy](/dcos/services/kubernetes/2.2.0-1.13.3/img/haproxy.png)
...
To configure `kubectl` to access the Kubernetes API using this setup, follow the steps described in the ["Without TLS verification"](/dcos/services/kubernetes/2.2.0-1.13.3/operations/connecting-clients#without-tls-verification) subsection of the [Connecting Clients](/dcos/services/kubernetes/2.2.0-1.13.3/operations/connecting-clients/) page.
...
To configure `kubectl` to access the Kubernetes API using this setup, follow the steps described in the ["With TLS verification"](/dcos/services/kubernetes/2.2.0-1.13.3/operations/connecting-clients#with-tls-verification) subsection of the [Connecting Clients](/dcos/services/kubernetes/2.2.0-1.13.3/operations/connecting-clients/) page.
