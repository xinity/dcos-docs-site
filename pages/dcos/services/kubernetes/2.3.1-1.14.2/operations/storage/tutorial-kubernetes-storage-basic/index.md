...
![Screenshot of AWS EBS from above "in-use".](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-in-use.png)
...
![Screenshot of AWS EBS from above still "available".](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-available.png)
...
![Screenshot of AWS EBS volume absent from where it had been.](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-missing.png)
...
![Screenshot of AWS EBS volume "available" for newly created volume.](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-pre-provisioned-created.png)
...
![Screenshot of AWS EBS from above "in-use".](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-pre-provisioned-in-use.png)
...
![Screenshot of AWS EBS volume "available" with Retain reclaim policy.](/dcos/services/kubernetes/2.3.1-1.14.2/img/ebs-pre-provisioned-available-retain.png)
