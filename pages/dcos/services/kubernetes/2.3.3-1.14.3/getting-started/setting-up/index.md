...
3. **Moreover, if the [TLS certificate](/dcos/services/kubernetes/2.3.3-1.14.3/operations/connecting-clients/) used by DC/OS is not trusted in your case, you can run the following command to disable TLS verification for the purposes of completing this tutorial:**
...
Now that you have your DC/OS cluster all set up, you are ready to [install the Mesosphere Kubernetes Engine](/dcos/services/kubernetes/2.3.3-1.14.3/getting-started/installing-mke/).
