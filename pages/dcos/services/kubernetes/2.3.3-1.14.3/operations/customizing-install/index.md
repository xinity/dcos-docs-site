...
This section continues on from the instructions given in the [Basic Installation](/dcos/services/kubernetes/2.3.3-1.14.3/getting-started/provision-install/) section.
...
See the [Cluster Sizing](/dcos/services/kubernetes/2.3.3-1.14.3/operations/cluster-sizing/) page for a more detailed explanation.
...
It is possible that the region may not have the resources required, make sure to read and understand [Cluster Sizing](/dcos/services/kubernetes/2.3.3-1.14.3/operations/cluster-sizing/) before attempting a deployment.
...
**NOTE:** Multi-Region deployment is not supported, see [Limitations](/dcos/services/kubernetes/2.3.3-1.14.3/limitations/index/).
...
![alt text](/dcos/services/kubernetes/2.3.3-1.14.3/img/tls.png "TLS design")
