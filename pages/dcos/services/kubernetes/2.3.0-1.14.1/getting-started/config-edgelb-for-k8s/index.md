...
Now you have configured Edge-LB to connect to your Kubernetes clusters. In the last section, you will [test connections and view the Kubernetes Dashboard](/dcos/services/kubernetes/2.3.0-1.14.1/getting-started/test-connect/) via a web proxy on your browser.
