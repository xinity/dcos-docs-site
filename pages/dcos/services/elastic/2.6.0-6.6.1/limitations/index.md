...
As a workaround, you should be able to expose Kibana using [EdgeLB](https://docs.mesosphere.com/services/edge-lb/) by following the following how-to: [Expose Kibana using EdgeLB](/dcos/services/elastic/2.6.0-6.6.1/how-to-guides#expose-kibana-using-edgelb).
