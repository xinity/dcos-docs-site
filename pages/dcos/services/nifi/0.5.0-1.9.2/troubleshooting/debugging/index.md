...
If you forgot to run `janitor.py` the last time you ran the service, see [Uninstall](/dcos/services/nifi/0.5.0-1.9.2/uninstall/) for the procedure. For reference, here is what happened:
