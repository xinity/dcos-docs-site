...
* A running DC/OS 1.11 cluster. (If you do not have one installed, see the instructions in [Getting Started](/dcos/services/minio/0.1.0/getting-started/#install-a-basic-cluster).)
