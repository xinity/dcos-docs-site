...
如需更多信息，请参阅 [命令名称](/dcos/cn/1.12/cli/command-reference/#dcos-marathon)。
...
在 DC/OS [**服务**](/dcos/cn/1.12/gui/) 选项卡中，使用 JSON 编辑器将以下内容添加为 Marathon 任务。根据需要清理的内容，替换传递到 `-r`/`-z` 的值。
