...
1. 将此脚本添加到 bootstrap 节点的 `genconf` 文件夹。[更多信息](/dcos/cn/1.12/installing/production/deploying-dcos/installation/#create-a-fault-domain-detection-script)。

1. [安装 DC/OS ](/dcos/cn/1.12/installing/production/deploying-dcos/installation/#create-a-fault-domain-detection-script)。
...
在 Marathon 服务或 pod 定义中，可以使用 [布局约束](/dcos/cn/1.12/deploying-services/marathon-constraints/)，以便：
...
要增加容量，请 [添加新代理](/dcos/cn/1.12/administering-clusters/add-a-node/) 到群集的远程分域或分区，然后更新服务以在相应的一个或多个分域启动实例。
