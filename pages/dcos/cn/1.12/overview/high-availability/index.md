...
通过 DC/OS，您可以在机架之间将主控分配给 HA。代理可以跨地区分配，建议您用描述其位置的属性来标记代理。ZooKeeper 等同步服务也应留在同一区域内，以减少网络延迟。有关详细信息，请参阅实现高可用性的 [配置区域和地区](/dcos/cn/1.12/installing/production/advanced-configuration/configuring-zones-regions/)。
 ...
 * 使用 HA 负载均衡器，如 [Marathon-LB](/services/marathon-lb/)，或内部 [第 4 层负载均衡器](/dcos/cn/1.12/networking/load-balancing-vips/)。
