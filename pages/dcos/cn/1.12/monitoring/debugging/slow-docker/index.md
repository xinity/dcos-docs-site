...
如果 DC/OS  1.10 或更新版本 Docker 服务或部署运行缓慢，可增加服务定义中所需的 CPU 数量。[从 CLI](/dcos/cn/1.12/deploying-services/update-user-service/) 或 DC/OS GUI 的 [服务](/dcos/cn/1.12/gui/services/)选项卡，将服务定义的 `cpus` 属性变为一个更大的值，并测试提高 CPU 分配后是否解决了问题。
