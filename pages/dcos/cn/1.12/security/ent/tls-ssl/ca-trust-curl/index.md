...
**先决条件：**[DC/OS CA 根证书](/dcos/cn/1.12/security/ent/tls-ssl/get-cert/)的本地副本。

如果您没有[设置代理](/dcos/cn/1.12/security/ent/tls-ssl/haproxy-adminrouter/)，您应该在 `curl` 命令中使用 `--cacert dcos-ca.crt`。
