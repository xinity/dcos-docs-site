...
也可以 [在无法访问任务时配置 Marathon 的行为](/dcos/cn/1.11/deploying-services/task-handling/configure-task-handling/)。

![Task Handling Flow](/dcos/cn/1.11/img/task-handling-corrected.png)
