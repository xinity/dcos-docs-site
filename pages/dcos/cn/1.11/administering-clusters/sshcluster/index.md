...
2. SSH 至集群。
 ...
 要查找代理 ID，选择 DC/OS [Web 界面](/dcos/cn/1.11/gui/) 中的 **节点** 选项卡并单击 **详细信息**。

 ![Web 界面节点 ID](/dcos/cn/1.11/img/ssh-node-id.png)
...
1. 使用 PuTTYgen 转换 `.pem` 文件类型为 `.ppk` ：
 ...
 ![Windows](/dcos/cn/1.11/img/windowsputtykey.png)
 ...
 * **要 SSH 至管理节点：**
 ...
 ![Putty 配置](/dcos/cn/1.11/img/windowsputtybasic.png)

 图 3. PuTTY 配置

 3. 在 PuTTY 窗口左侧的 **类别** 窗格中，选择 **连接 > SSH > Auth**，单击 **浏览**，查找并选择您的 `.ppk` 文件，然后单击 **打开**。

 ![Putty SSH 选项](/dcos/cn/1.11/img/windowsputtysshopt.png)

 图 4. PuTty SSH 选项

 4. 如果您正在运行 CoreOS，则以“core”用户登录。CentOS 上的默认用户是“centos”。

 ![Windows 登录](/dcos/cn/1.11/img/windowscore.png)
 ...
 **先决条件：** 您必须退出管理节点。
 ...
 ![Windows 转发](/dcos/cn/1.11/img/windowsforwarding.png)
 ...
 ![Windows Pageant](/dcos/cn/1.11/img/windowspageant.png)
