...
如果您在 Admin Router 前运行 HAProxy，您应该保护它们之间的通信安全。有关保护您的通信的信息，请参阅[文档](/dcos/cn/1.11/security/oss/tls-ssl/haproxy-adminrouter/)。
...
[Marathon-LB](/dcos/cn/1.11/networking/marathon-lb/) 和 HTTPS
管理入口流量。
...
包括 AWS 负载均衡器的典型 AWS 部署如下所示：
    ...
    ![安全区](/dcos/cn/1.11/img/security-zones.jpg)
...
请参阅 [安全部分](/dcos/cn/1.11/security/) 了解更多信息。
