...
您可以从 [DC/OS Web 界面](/dcos/cn/1.11/gui/)的**Services > Services**选项卡，下载服务的所有日志文件。您也可以监控 `stdout`/`stderr`。

如需更多信息，请参阅“服务和任务日志”[快速入门指南](/dcos/cn/1.11/monitoring/logging/quickstart/)。
...
输入组件名，您可以查看特定 [组件](/dcos/cn/1.11/overview/architecture/components/) 的日志。例如，要访问 Admin Router 日志，可运行此命令：
...
![系统健康](/dcos/cn/1.11/img/ui-system-health-logging.png)
...
- [使用 ELK 进行日志管理](/dcos/cn/1.11/monitoring/logging/aggregating/elk/)
- [使用 Splunk 进行日志管理](/dcos/cn/1.11/monitoring/logging/aggregating/splunk/)
