...
某些 DC/OS 服务（如 [Kafka](/dcos/cn/services/kafka/)）在您安装它们时会自动创建 VIP。命名约定是：`broker. <service.name>.l4lb.thisdcos.directory:9092`。
...
**先决条件：** Kafka 服务和 CLI 必须 [已安装](/dcos/cn/services/kafka/)。
