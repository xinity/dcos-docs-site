...
您可以授予用户访问 [**作业**屏幕](/dcos/cn/1.11/gui/jobs/) 的权限。新用户默认没有权限。
...
6. 在 **Permissions Strings** 字段中复制并粘贴权限。根据您的 [安全模式](/dcos/cn/1.11/security/ent/#security-modes 选择权限字符串)，单击**ADD PERMISSIONS**，然后单击**Close**。
