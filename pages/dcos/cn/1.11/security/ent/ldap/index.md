...
查看 [管理用户和组] 中的 DC/OS 用户 ID 要求(/dcos/cn/1.11/security/ent/users-groups/)。

**要求** 目录服务器必须支持 [LDAP 3](https://tools.ietf.org/html/rfc4511)。

若要设置 LDAP 连接，请执行以下操作:

1. [配置您的连接](/dcos/cn/1.11/security/ent/ldap/ldap-conn/)。

2. [配置身份认证](/dcos/cn/1.11/security/ent/ldap/ldap-auth/)。

3. [验证连接](/dcos/cn/1.11/security/ent/ldap/ldap-verify/)。
