...
如果您在 Enterprise 集群上运行 Marathon-LB 时遇到问题，请尝试按照[这些说明](/dcos/cn/services/marathon-lb/mlb-auth/)进行安装。根据您的 [安全模式](/cn/1.11/security/ent/#security-modes)，Marathon-LB 可能需要服务身份认证才能访问 DC/OS。
