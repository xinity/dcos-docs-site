...
#### 代理模板
[代理](#private-agent) 模板创建 [公共](/dcos/cn/1.11/overview/concepts/#public-agent-node) 或 [专用](/dcos/cn/1.11/overview/concepts/#private-agent-node) 代理节点，然后作为 AutoScalingGroup 的一部分附加到 DC/OS 群集。
