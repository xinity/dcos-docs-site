...
1. 使用 [自定义高级安装说明 安装 DC/OS](/dcos/cn/1.11/installing/production/deploying-dcos/installation/)。以下是 GPU 特定的配置参数：
...
2. 请根据 [此处](/dcos/cn/1.11/installing/evaluation/cloud-installation/aws/advanced/) 说明，使用以下 GPU 专用配置创建具有高级 AWS 模板的群集。
