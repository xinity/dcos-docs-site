...
![Spark 仪表板](/dcos/cn/services/img/spark-dashboard.png)

图 1. 服务 > {{ model.techShortName }} 服务

3. 选择要更新的 {{ model.techShortName }} 框架的名称。

![Spark 框架详情](/dcos/cn/services/img/spark-framework-details.png)
...
![Spark 配置屏幕](/dcos/cn/services/img/spark-config-properties.png)

图 3. {{ model.techShortName }} 配置屏幕

6. 单击 **查看和运行**按钮以应用任何更改并干净地重新加载 {{ model.techShortName }}。

![查看按钮](/dcos/cn/services/img/review-and-run-button.png)
