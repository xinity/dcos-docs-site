...
在 [DC/OS 严格安全模式](/dcos/cn/1.11/security/)下运行时，调度器和作业都
必须使用 [DC/OS 服务帐户 进行 Mesos 认证](/dcos/cn/1.11/security/service-auth/)。

#include /dcos/cn/services/include/service-account.tmpl
...
参见[官方文档](/dcos/cn/1.11/security/ent/secrets/)。
