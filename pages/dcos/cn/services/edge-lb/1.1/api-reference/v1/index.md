...
要验证 API 请求，请参阅 [获取身份认证令牌](/dcos/cn/1.11/security/ent/iam-api/#obtaining-an-authentication-token) 和 [传递身份认证令牌](/dcos/cn/1.11/security/ent/iam-api/#pass-an-authentication-token)。
...
[swagger api='/dcos/services/api/edge-lb-v1.yaml']
