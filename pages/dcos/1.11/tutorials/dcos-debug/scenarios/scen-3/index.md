...
As we learned [earlier](/dcos/1.11/tutorials/dcos-debug/gen-strat/), with application failures the [first step](/dcos/1.11/tutorials/dcos-debug/gen-strat/#task-strat) is to check the [task logs](/dcos/1.11/tutorials/dcos-debug/tools/#task-logs).
...
However, this does not shed much light on why the task failed. So then to [Step 3](/dcos/1.11/tutorials/dcos-debug/gen-strat/#agent-strat) of our [strategy](/dcos/1.11/tutorials/dcos-debug/gen-strat/): check the [Mesos agent logs](/dcos/1.11/tutorials/dcos-debug/tools/#agent-logs) using:
