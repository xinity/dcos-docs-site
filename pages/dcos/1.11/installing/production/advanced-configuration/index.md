...
**Caution:** If you want to modify the configuration file after installation, you must follow the [DC/OS upgrade process](/dcos/1.11/installing/production/upgrading/).
