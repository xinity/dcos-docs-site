...
- Prerequisites - This roles handles all of the [requirements to run DC/OS](/dcos/1.11/installing/production/system-requirements/#software-prerequisites).
