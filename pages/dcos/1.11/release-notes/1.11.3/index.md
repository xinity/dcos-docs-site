...
- The Kubernetes package dependencies are documented [here](/dcos/services/kubernetes/1.2.0-1.10.5/install).
...
- UCR
  ...
  -  Support for Docker image pull secrets. [View the documentation](/dcos/1.11/deploying-services/containerizers/). An example for Docker credentials is [here](/dcos/1.11/installing/production/deploying-dcos/configuration/examples/#docker-credentials). [enterprise type="inline" size="small" /]
