...
Review the DC/OS user ID requirements in [Managing users and groups](/dcos/1.11/security/ent/users-groups/).

**Requirement** The directory server must support [LDAP 3](https://tools.ietf.org/html/rfc4511).

To set up an LDAP connection:

1. [Configure your connection](/dcos/1.11/security/ent/ldap/ldap-conn/).

2. [Configure your authentication](/dcos/1.11/security/ent/ldap/ldap-auth/).

3. [Verify the connection](/dcos/1.11/security/ent/ldap/ldap-verify/).
