...
1.  Click **Add Directory**.
   ...
   ![Add Directory dialog](/dcos/1.11/img/ldap-add-dir-conn.png)
...
1.  Specify your authentication method and parameters, as discussed in the [authentication section](/dcos/1.11/security/ent/ldap/ldap-auth/).
