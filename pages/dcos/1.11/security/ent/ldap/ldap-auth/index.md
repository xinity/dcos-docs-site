...
1.  When you have completed your entries, the dialog should look something like the following.
   ...
   ![Simple bind parameters](/dcos/1.11/img/ldap-add-dir-auth-simple-bind.png) 

   Figure 1. Simple bind parameters 

1.  Click **Add Directory**.

1.  [Verify your connection](/dcos/1.11/security/ent/ldap/ldap-verify/).
...
1.  When you have completed your entries, the dialog should look something like the following.
   ...
   ![Search/bind parameters](/dcos/1.11/img/ldap-add-dir-auth-search-bind.png)
