...
There are [four commands](/dcos/1.11/cli/command-reference/dcos-security/#dcos-security-org) used for managing permissions from the DC/OS Enterprise CLI.
...
The [IAM HTTP API](/dcos/1.11/security/ent/iam-api/) provides operations to manage permissions for users and groups.
