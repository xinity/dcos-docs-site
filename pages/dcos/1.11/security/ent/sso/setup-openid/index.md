...
1. Paste the client secret value from Google into the **Client Secret** field.
    ...
    ![Google IdP Configuration](/dcos/1.11/img/oidc-google.png)
...
1. Assign this user the appropriate [permissions](/dcos/1.11/security/ent/perms-reference/).

### <a name="using-cli"></a>Using the DC/OS CLI

**Prerequisite:** [DC/OS CLI installed](/dcos/1.11/cli/install/).
...
1. You should see a message similar to the following.
    ...
    ![CLI IdP Auth Token](/dcos/1.11/img/cli-auth-token.png)
