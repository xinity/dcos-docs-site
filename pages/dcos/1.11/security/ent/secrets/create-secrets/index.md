...
See [Configuring services and pods to use secrets](/dcos/1.11/security/ent/secrets/use-secrets/) for information on how to reference these secrets in your app or pod definition.
...
Secrets should include paths, unless you want to allow all services to access its value. See [Spaces](/dcos/1.11/security/ent/#spaces) for more information about secret paths.
...
1. Click the **+** icon in the top right.
    ...
    ![New Secret](/dcos/1.11/img/new-secret.png)
...
1. Type or paste the secret into the **Value** box.
    ...
    ![Secret ID/Value Fields](/dcos/1.11/img/create-secret.png)
...
1. Use `dcos auth login` to log into the CLI. You can find more information about this command in the [CLI Reference](/dcos/1.11/cli/command-reference/dcos-auth/dcos-auth-login/).
