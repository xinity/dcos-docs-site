...
**Prerequisite:** A local copy of the [root certificate of your DC/OS CA](/dcos/1.11/security/ent/tls-ssl/get-cert/).

If you have not [set up a proxy](/dcos/1.11/security/ent/tls-ssl/haproxy-adminrouter/), you should use `--cacert dcos-ca.crt` in your `curl` commands in `permissive` and `strict` security modes.
