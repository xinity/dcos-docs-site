...
- An external [LDAP directory](/dcos/1.11/security/ent/ldap/).
- An [OpenID Connect or SAML provider](/dcos/1.11/security/ent/sso/).
...
6. When completed, your dialog should look something like the following.
   ...
   ![LDAP Group Import Configuration](/dcos/1.11/img/1-11-ldap-group-import.png)
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/dcos/1.11/security/ent/iam-api/) endpoint.
