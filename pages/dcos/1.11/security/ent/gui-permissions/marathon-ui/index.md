...
### Task details and logs
    To view task details and logs, you must grant access to the [Mesos UI](/dcos/1.11/security/ent/gui-permissions/mesos-ui/).   
...
### Task details and logs
    To view Marathon task details and logs, you must grant access to the [Mesos UI](/dcos/1.11/security/ent/gui-permissions/mesos-ui/).
