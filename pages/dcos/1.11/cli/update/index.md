...
1. Select **Install CLI** to bring up the installation commands.
    ...
    ![CLI install UI](/dcos/1.11/img/install-cli.png)
...
1. Copy and paste the code snippets appropriate to your OS into your terminal and press the return key. This automatically downloads, moves, and runs the setup command for the cluster. The last command to run, `dcos`, will display an overview of the dcos commands.
    ...
    ![CLI copy/paste](/dcos/1.11/img/install-cli-terminal.png)
...
For information about configuration options when using the DC/OS CLI, see [Configuring the command-line interface](/dcos/1.11/cli/configure/). For information about authentication and authorization when using the DC/OS CLI, see the appropriate [Security](/dcos/1.11/security/) section.
