...
To determine the address of your cluster, see [Cluster Access](/dcos/1.11/api/access/).
...
All Logging API routes require authentication to use. To authenticate API requests, see [Obtaining an authentication token](/dcos/1.11/security/ent/iam-api/#/obtaining-an-authentication-token) and [Passing an authentication token](/dcos/1.11/security/ent/iam-api/#/passing-an-authentication-token).
...
All routes may also be reached by users with the _dcos:superuser_ permission. To assign permissions to your account, see [Permissions Reference](/dcos/1.11/security/ent/perms-reference/).
...
# Resources
 ...
 [swagger api='/dcos/1.11/api/logs2.yaml']
