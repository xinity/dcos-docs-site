...
This topic describes how to use the DC/OS CLI to configure services. You can also customize services by using the [**Services**](/dcos/1.11/gui/services/) tab in the DC/OS UI.
...
For more information, see the [dcos package](/dcos/1.11/cli/command-reference/dcos-package/) documentation.
