...
1.  [SSH](/dcos/1.11/administering-clusters/sshcluster/) to your private agent node.
    ```bash
...
In this step, a Marathon Service Account is created. Depending on your [security mode](/dcos/1.11/security/ent/#security-modes), a Marathon Service Account is either optional or required.
