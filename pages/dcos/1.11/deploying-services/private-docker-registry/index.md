...
Follow these steps to add your Docker registry credentials to the [DC/OS Enterprise secrets store](/dcos/1.11/security/ent/secrets/), and then reference that secret in your service definition.
...
1. Add the `config.json` file to the DC/OS secret store. [Learn more about creating secrets](/dcos/1.11/security/ent/secrets/create-secrets/).
