...
### Prerequisites
- DC/OS [installed](/dcos/1.11/installing/)
...
You can also launch a pod from the [**Services**](/dcos/1.11/gui/) tab of the DC/OS web interface. Select **Services -> Services -> RUN A SERVICE -> Multi-container (Pod)**, then toggle to JSON mode and paste in the application definition supplied above.
...
![Pods UI](/dcos/1.11/img/pods-service-dashboard.png)
