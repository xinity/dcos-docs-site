...
This is not currently supported. For more information, see [this document](/dcos/1.11/installing/production/advanced-configuration/configuring-zones-regions/).
...
For more information, see the installation [documentation](/dcos/1.11/installing/).
