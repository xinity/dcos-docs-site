...
2. Add this script to the `genconf` folder of your bootstrap node. [More information](/dcos/1.11/installing/production/deploying-dcos/installation/#create-a-fault-domain-detection-script).

1. [Install DC/OS](/dcos/1.11/installing/production/deploying-dcos/installation/).
