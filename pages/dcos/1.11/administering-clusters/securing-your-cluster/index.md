...
- from external machines to public agent nodes: block connection requests on all ports except [advertised port ranges](/dcos/1.11/installing/production/system-requirements/ports/#agent).
...
If you run HAProxy in front of Admin Router, you should secure the communication between them. For information about securing your communication, see the [documentation](/dcos/1.11/security/ent/tls-ssl/haproxy-adminrouter/).
...
[Marathon-LB](/dcos/services/marathon-lb/1.12/) with HTTPS for
...
![Security Zones](/dcos/1.11/img/security-zones.jpg)
...
See the [Security section](/dcos/1.11/security/) for more information.
