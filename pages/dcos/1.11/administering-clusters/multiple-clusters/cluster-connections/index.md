...
You connect to multiple DC/OS clusters using [dcos cluster](/dcos/1.11/cli/command-reference/dcos-cluster/) commands.
...
- UNCONFIGURED : the cluster was not set up locally (i.e., the cluster is [linked](/dcos/1.11/administering-clusters/multiple-clusters/cluster-links/) to the currently attached cluster).
