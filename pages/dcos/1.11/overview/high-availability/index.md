 ...
 * Using an HA load balancer like [Marathon-LB](/dcos/services/marathon-lb/1.12/), or the internal [Layer 4 load balancer](/dcos/1.11/networking/load-balancing-vips/).
