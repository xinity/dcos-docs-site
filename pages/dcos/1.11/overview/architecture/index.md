...
![DC/OS Architecture Layers](/dcos/1.11/img/dcos-architecture-layers.png)
...
For more information, see [Task Types](/dcos/1.11/overview/architecture/task-types/).
...
- [Components](/dcos/1.11/overview/architecture/components/)
- [Node Types](/dcos/1.11/overview/architecture/node-types/)
- [Host Operating System](/dcos/1.11/overview/concepts/#host-operating-system).
...
For more information, see [Installing](/dcos/1.11/installing/).
...
- [GUI](/dcos/1.11/gui/)
- [CLI](/dcos/1.11/cli/)
- [package repository](/dcos/1.11/administering-clusters/repo/)
- [container registry](/dcos/1.11/overview/concepts/#container-registry)
