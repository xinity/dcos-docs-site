...
![DC/OS Node Types](/dcos/1.11/img/dcos-node-types.png)
...
A public agent node is an agent node that is on a network that allows ingress from outside of the cluster via the cluster’s [infrastructure networking](/dcos/1.11/overview/concepts/#infrastructure-network).
...
A private agent node is an agent node that is on a network that does not allow access from outside of the cluster via the cluster’s [infrastructure networking](/dcos/1.11/overview/concepts/#infrastructure-network).
...
For more on master and agent node components, see [Components](/dcos/1.11/overview/architecture/components/).

For more on security, see [Securing Your Cluster](/dcos/1.11/administering-clusters/).

For more on scaling your cluster, see [Adding Agent Nodes](/dcos/1.11/administering-clusters/add-a-node/).

For more on configuring public nodes, see [Converting Agent Node Types](/dcos/1.11/administering-clusters/convert-agent-type/).
