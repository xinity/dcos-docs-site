...
![Agent configuration for containers running on `MesosContainerizer` and Docker once the VxLAN has been configured.](/dcos/1.11/img/overlay-fig-1.png)
...
![Software architecture for DC/OS overlay control plane.](/dcos/1.11/img/overlay-fig-2.png)
