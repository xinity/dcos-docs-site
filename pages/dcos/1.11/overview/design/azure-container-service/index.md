...
For a more comprehensive architectural description of DC/OS, see [DC/OS Architecture](/dcos/1.11/overview/architecture/).

For a more complete discussion of components, see [DC/OS Components](/dcos/1.11/overview/architecture/components/).
...
![Azure Container Service architecture using DC/OS.](/dcos/1.11/img/dcos-acs.png)
