...
# Isolating Resources
DC/OS Enterprise [security features](/dcos/1.12/security/ent/) provide robust fine-grained access control. However, there are situations when you might want a partitioned environment, for example:
