...
The process for updating packages from the [DC/OS Catalog](/dcos/1.12/gui/catalog/) is different. For more information, see the [documentation](/dcos/1.12/deploying-services/config-universe-service/).
