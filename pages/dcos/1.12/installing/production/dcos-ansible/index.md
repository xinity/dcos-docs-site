...
- Prerequisites - This roles handles all of the [requirements to run DC/OS](/dcos/1.12/installing/production/system-requirements/#software-prerequisites).
...
To learn more about using Terraform as your deployment manager visit the [Universal Installer page](/dcos/1.12/installing/evaluation/).
