...
For more information, see the [multi-zone](/dcos/1.12/installing/production/advanced-configuration/configuring-zones-regions/multi-zone/) and [multi-region](/dcos/1.12/installing/production/advanced-configuration/configuring-zones-regions/multi-region/) documentation.
 ...
 * Using an HA load balancer like [Marathon-LB](/dcos/services/marathon-lb/1.12/), or the internal [Layer 4 load balancer](/dcos/1.12/networking/load-balancing-vips/).
