...
If your node has gone down in an unplanned way, you only have to [Decommission the node](/dcos/1.12/administering-clusters/delete-node/#decommission-the-node/).
...
1. [SSH to the agent node](/dcos/1.12/administering-clusters/sshcluster/) you wish to shut down.
