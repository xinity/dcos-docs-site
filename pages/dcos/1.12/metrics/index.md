...
* **Container:** Metrics about `cgroup` allocations from tasks running in the DC/OS [Universal Container Runtime](/dcos/1.12/deploying-services/containerizers/ucr/) or [Docker Engine](/dcos/1.12/deploying-services/containerizers/docker-containerizer/) runtime.
...
For more information about the list of metrics that are automatically collected by DC/OS, read [Metrics Reference](/dcos/1.12/metrics/reference/) documentation.
