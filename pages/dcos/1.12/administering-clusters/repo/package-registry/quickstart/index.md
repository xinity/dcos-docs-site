...
The DC/OS Package Registry is included with DC/OS Enterprise 1.12. If needed, please follow the [instructions for upgrading to DC/OS 1.12](/dcos/1.12/installing/production/upgrading/) first before continuing.
