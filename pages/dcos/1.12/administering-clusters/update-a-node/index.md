...
*   [SSH installed and configured](/dcos/1.12/administering-clusters/sshcluster/). This is required when removing nodes by manually killing agents.
*   Access to the [Admin Router permissions](/dcos/1.12/overview/architecture/components/#admin-router).
...
1.  Open a secure shell [SSH](/dcos/1.12/administering-clusters/sshcluster/) on the agent nodes.
