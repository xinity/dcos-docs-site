...
- [DC/OS](/dcos/1.12/installing/)
- [DC/OS CLI](/dcos/1.12/cli/) must be installed, configured, and logged in.
...
**Important:** The following example requires journald task logging, which by default is [disabled](/dcos/1.12/monitoring/logging/logging-api/#compatibility).
