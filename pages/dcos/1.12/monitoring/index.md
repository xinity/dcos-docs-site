...
![node detail](/dcos/1.12/img/GUI-Components-Compenent_Detail_View-1_12.png)

Figure 2. Individual component detail

You can debug further by clicking the node to view the component `journald` (log) output.

![log](/dcos/1.12/img/GUI-Components-Individual_Node_Detail_View-1_12.png)
