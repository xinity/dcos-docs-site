...
To determine which agents are public agents, see [Finding a Public Agent IP](/dcos/1.12/administering-clusters/locate-public-agent/).
...
For more information, see [Securing Your Cluster](/dcos/1.12/administering-clusters/).
