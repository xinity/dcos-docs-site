...
![Mesosphere DC/OS Enterprise Components](/dcos/1.12/img/dcos-components-1-12-updated.png)
...
- [Documentation](/dcos/1.12/installing/)
...
- [Documentation](/dcos/1.12/administering-clusters/backup-and-restore/)
- [API Reference](/dcos/1.12/administering-clusters/backup-and-restore/backup-restore-api/)
...
- [Documentation](/dcos/1.12/deploying-services/)
- [Source](https://github.com/mesosphere/marathon)
- [API Reference](/dcos/1.12/deploying-services/marathon-api/)
...
- [Documentation](/dcos/1.12/deploying-jobs/)
...
- [API Reference](/dcos/1.12/monitoring/#system-health-http-api-endpoint)
...
- [API Reference](/dcos/1.12/monitoring/logging/logging-api/)
...
- [API Reference](/dcos/1.12/metrics/metrics-api/)

<a name="dcos-signal"></a>

## DC/OS signal

The DC/OS signal service reports cluster telemetry and analytics to help improve DC/OS. Administrators can [opt out of telemetry](/dcos/1.12/installing/oss/opt-out/#telemetry) at installation time.
...
- [API Reference](/dcos/1.12/networking/DNS/mesos-dns/mesos-dns-api/)
...
The DC/OS package manager (Cosmos) installs and manages DC/OS packages from [DC/OS package repositories](/dcos/1.12/administering-clusters/repo/), such as the [Mesosphere Universe](https://github.com/mesosphere/universe).
...
- [API Reference](/dcos/1.12/deploying-services/package-api/)
...
- [API Reference](/dcos/1.12/administering-clusters/component-management/)
...
- [Documentation](/dcos/1.12/security/)
- [API Reference](/dcos/1.12/security/ent/iam-api/)
...
- [Documentation](/dcos/1.12/security/ent/tls-ssl/)
- [API Reference](/dcos/1.12/security/ent/tls-ssl/ca-api/)
...
- [Documentation](/dcos/1.12/security/ent/secrets/)
- [API Reference](/dcos/1.12/security/ent/secrets/secrets-api/)
...
Most DC/OS components run as [systemd services](/dcos/1.12/overview/concepts/#systemd-service) on the DC/OS nodes.
