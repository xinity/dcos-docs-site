...
1.  From the DC/OS [GUI](/dcos/1.12/gui/), click on the **Services** tab, then on **RUN A SERVICE**.
    ...
    2.  Expand **ADD SERVICE ENDPOINT** and provide responses for:
        ...
        ![VIP service definition](/dcos/1.12/img/vip-service-definition.png)
...
![VIP output](/dcos/1.12/img/vip-service-definition-output.png)
 
Figure 2. Service definition output

For more information on port configuration, see the [Marathon ports documentation](/dcos/1.12/deploying-services/service-ports/).
...
1.  Select your task to view details.
    ...
    ![Service details](/dcos/1.12/img/vip-service-details.png)
