...
installation of the [Core and Enterprise CLI plugins](/dcos/1.12/cli/plugins/) from
...
the system needs access to the internet or a [local universe](/dcos/1.12/administering-clusters/deploying-a-local-dcos-universe/).
