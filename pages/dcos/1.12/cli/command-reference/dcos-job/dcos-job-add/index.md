...
For job examples, see the [Create a Job](/dcos/1.12/deploying-jobs/examples/#create-job).

For information on how to create a job using this command, see [Add a job](/dcos/1.12/deploying-jobs/quickstart/#add-a-job-2).
