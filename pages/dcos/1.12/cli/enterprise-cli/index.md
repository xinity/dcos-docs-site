...
- [`dcos backup`](/dcos/1.12/cli/command-reference/dcos-backup/)
- [`dcos license`](/dcos/1.12/cli/command-reference/dcos-license/)
- [`dcos security`](/dcos/1.12/cli/command-reference/dcos-security/)

# <a name="ent-cli-install"></a>Installing the DC/OS Enterprise CLI

## Prerequisite

The DC/OS CLI must already be [installed](/dcos/1.12/cli/install/).
