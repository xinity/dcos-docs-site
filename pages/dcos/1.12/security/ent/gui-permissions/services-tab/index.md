...
**Tip:** This procedure grants full user access to the **Services** tab. If you want to configure fine-grained user access, see the [documentation](/dcos/1.12/deploying-services/service-groups/).
