...
**Tip:** This procedure grants full user access to the **Secrets** tab. If you want to configure fine-grained user access, see the [documentation](/dcos/1.12/security/ent/secrets/use-secrets/).

## <a name="network-access-via-ui"></a>Grant Access by using the GUI

**Prerequisites:**

- A DC/OS user account without the `dcos:superuser` [permission](/dcos/1.12/security/ent/users-groups/).
...
1.  Select the name of the user or group to grant the permission to.
    ...
    ![Add permission to a user or group](/dcos/1.12/img/GUI-Organization-Users-List_VIew-1_12.png)
...
1.  Click **INSERT PERMISSION STRING** to toggle the dialog.
    ...
    ![Add permission](/dcos/1.12/img/services-tab-user3.png)
...
1.  Copy and paste the permission in the **Permissions Strings** field. Choose the permission strings based on your [security mode](/dcos/1.12/security/ent/#security-modes) and click **ADD PERMISSIONS** and then **Close**.
