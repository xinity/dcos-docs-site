...
- An external [LDAP directory](/dcos/1.12/security/ent/ldap/).
- An [OpenID Connect or SAML provider](/dcos/1.12/security/ent/sso/).
...
6. When completed, your dialog should look something like the following.
   ...
   ![LDAP Group Import Configuration](/dcos/1.12/img/ldap-group-import.png)
...
You can import a group of LDAP users by using the `/ldap/importuser` [IAM API](/dcos/1.12/security/ent/iam-api/) endpoint.
...
- You must follow the steps in [Obtaining the root certificate of your DC/OS CA](/dcos/1.12/security/ent/tls-ssl/get-cert/) before issuing the curl commands in this section.
