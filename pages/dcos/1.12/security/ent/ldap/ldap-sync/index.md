...
DC/OS Enterprise supports [directory-based authentication via LDAP](/dcos/1.12/security/ent/ldap/). Users and user groups can be imported from the external directory into the DC/OS IAM. See [managing users and groups](/dcos/1.12/security/ent/users-groups/).
...
The exact period is configurable on installation. See the [configuration reference](/dcos/1.12/installing/production/advanced-configuration/configuration-reference/) under [advanced configuration](/dcos/1.12/installing/production/advanced-configuration/). 
