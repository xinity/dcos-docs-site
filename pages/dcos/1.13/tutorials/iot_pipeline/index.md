...
If you are having trouble getting Marathon-LB up and running on an Enterprise cluster, try installing it following [these instructions](/dcos/services/marathon-lb/1.13/mlb-install/). Depending on your [security mode](/security/ent/#security-modes), Marathon-LB may require service authentication for access to DC/OS.
