...
enterprise: false
---
In the [Quick start](../../quick-start/), you provisioned a Konvoy cluster with default configuration settings.
...
The `konvoy up` command provisions the cluster similar to how it is provisioned using the default settings as described in [Provision and deploy the cluster and addons](../quick-start/#provision-and-deploy-the-cluster-and-addons).
