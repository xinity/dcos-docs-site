...
![Deployment history](/zh/1.11/img/dcos-azure-marketplace-step2a.png)

图 1. 部署历史记录

2. 单击最新部署并复制 `MASTERFQDN` 到 `Outputs` 部分。

![Deployment output](/zh/1.11/img/dcos-azure-marketplace-step2b.png)
...
![Resource - Master Node Network Security Group](/zh/1.11/img/dcos-azure-step2case1a.png)

图 3. 管理节点网络安全组

2. 单击左侧的 **入站安全规则** 选项卡。

![Inbound Security Rules](/zh/1.11/img/dcos-azure-step2case1b.png)

图 4. 入站安全规则

3. 添加入站安全规则。

![Add Inbound Security Rules](/zh/1.11/img/dcos-azure-step2case1c.png)

图 5. 添加入站安全规则 

4. 查找管理节点的负载均衡器资源。

![Resource - Master Node Load balancer](/zh/1.11/img/dcos-azure-step2case1d.png)

图 6. 管理节点负载均衡器

5. 单击左侧的 **入站 NAT 规则** 选项卡，

![Inbound NAT Rules](/zh/1.11/img/dcos-azure-step2case1e.png)

图 7. 入站 NAT 规则

6. 添加入站 NAT 规则。

![Add Inbound NAT Rules](/zh/1.11/img/dcos-azure-step2case1f.png)
...
![DC/OS dashboard](/zh/1.11/img/dcos-gui.png)
