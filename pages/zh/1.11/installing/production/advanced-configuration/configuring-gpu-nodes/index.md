...
## 先决条件
- AWS DC/OS 高级模板 [系统要求](/zh/1.11/installing/evaluation/cloud-installation/aws/advanced/)。
...
2. 请根据 [此处](/zh/1.11/installing/evaluation/cloud-installation/aws/advanced/) 说明，使用以下 GPU 专用配置创建具有高级 AWS 模板的群集。
