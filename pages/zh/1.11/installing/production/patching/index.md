...
- 在修补 DC/OS 之前，请先查看 [版本注释](/zh/1.11/release-notes/)。
...
- [`dns_search`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#dns-search)
- [`docker_remove_delay`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#docker-remove-delay)
- [`gc_delay`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#gc-delay)
- [`resolvers`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#resolvers)
- [`telemetry_enabled`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#telemetry-enabled)
- [`use_proxy`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#use-proxy)
    - [`http_proxy`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#use-proxy)
    - [`https_proxy`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#use-proxy)
    - [`no_proxy`](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#use-proxy)
...
有关不同安全模式的更多信息，请参阅安全 [模式](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#security-enterprise)。
...
- 您必须熟悉 [DC/OS 安装指南](/zh/1.11/installing/production/deploying-dcos/installation/)。
- 修补之前要对 ZooKeeper 截屏。Marathon 支持返回查看，但不支持降级。
- 修补之前 [对 IAM 数据库截屏](/zh/1.11/installing/installation-faq/#q-how-do-i-backup-the-iam-database)。
...
- [备份您的群集](/zh/1.11/administering-clusters/backup-and-restore/)。
- **可选** 您可以将自定义 [节点和群集健康检查](/zh/1.11/installing/production/deploying-dcos/node-cluster-health-check/#custom-health-checks) 添加到 `config.yaml`。
 ...
 * `config.yaml` 的语法可能与早期版本不同。有关当前 `config.yaml` 语法和参数的详细说明，请参阅 [文档](/zh/1.11/installing/production/advanced-configuration/configuration-reference/)。
...
1. 构建安装工具包。
 ...
 1. 运行 [nginx](/zh/1.11/installing/production/deploying-dcos/installation/) 容器以提供安装文件。

1. 转到 DC/OS 管理节点 [程序](/zh/1.11/installing/production/patching/#masters) 完成安装。
...
该程序的在安全性严格 [模式](/zh/1.11/installing/production/advanced-configuration/configuration-reference/#security-enterprise) 下修补到 DC/OS 1.11。
