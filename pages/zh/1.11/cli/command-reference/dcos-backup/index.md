...
有关如何从 CLI 创建备份的信息，请参阅 [备份和恢复 CLI](/zh/1.11/administering-clusters/backup-and-restore/backup-restore-cli/)。此流程的限制可参见[备份和恢复限制部分](/zh/1.11/administering-clusters/backup-and-restore/#limitations)。
