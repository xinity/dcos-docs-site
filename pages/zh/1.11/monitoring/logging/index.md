...
如需更多信息，请参阅“服务和任务日志”[快速入门指南](/zh/1.11/monitoring/logging/quickstart/)。
...
![系统健康](/zh/1.11/img/ui-system-health-logging.png)
...
- [使用 ELK 进行日志管理](/zh/1.11/monitoring/logging/aggregating/elk/)
- [使用 Splunk 进行日志管理](/zh/1.11/monitoring/logging/aggregating/splunk/)
