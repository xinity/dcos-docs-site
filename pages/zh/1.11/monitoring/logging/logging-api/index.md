...
日志记录 API 由 [DC/OS 日志组件] 支持(/1.11/overview/architecture/components/#dcos-log)，后者在群集中的所有节点上运行。有关使用日志记录 API 的更多信息，请参阅 [日志记录](/zh/1.11/monitoring/logging/index.md)。关于使用示例，请参阅 [日志记录 API 示例](/zh/1.11/monitoring/logging/logging-api-examples/index.md)。
...
要确定群集的地址，请参阅 [群集访问](/zh/1.11/api/access/)。
