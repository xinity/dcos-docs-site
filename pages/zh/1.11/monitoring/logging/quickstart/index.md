...
- 您必须以超级用户身份登录，或者已被授予对日志记录的用户访问权限。如需更多信息，请参阅 [访问系统和组件日志](/zh/1.11/monitoring/logging/access-component-logs/) 和 [访问任务日志](/zh/1.11/monitoring/logging/access-task-logs/)。
