...
1. [通过 SSH 进入主节点](/zh/1.11/administering-clusters/sshcluster/)。
 ...
 **注意：**默认情况下，DC/OS 将 ZooKeeper 超级用户设置为 `super:secret`，但我们建议[更改默认值](zh/1.11/install/production/advanced-configuration/configuration-reference/#zk-superuser)。
...
祝贺您！您已成功重新初始化密钥存储库。要拆封它，请参阅[使用自定义钥匙拆封密封的密钥存储库](/zh/1.11/security/ent/secrets/unseal-store/#unseal-cust-keys)。
