...
在安装过程中，代理节点被指定为 [公共](/zh/1.11/overview/concepts/#public-agent-node) 或 [私有](/zh/1.11/overview/concepts/#private-agent-node)节点。默认情况下，它们在 GUI 或 CLI [安装](/zh/1.11/installing/evaluation/cloud-installation/) 方法中被指定为私有节点。
...
### 安装 DC/OS 代理节点
复制存档的 DC/OS 安装程序文件（`dcos-install.tar`）到代理节点。此存档在 GUI 或 CLI [安装](/zh/1.11/installing/evaluation/cloud-installation/)方法期间创建。
