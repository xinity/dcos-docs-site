...
- [已安装 DC/OS CLI](/zh/1.11/cli/install/)。
...
1. 使用以下命令 [SSH](/zh/1.11/administering-clusters/sshcluster/) 至管理节点。使用先前命令中使用的 IP 地址替换 `<master-IP>` 。
...
1. [SSH](/zh/1.11/administering-clusters/sshcluster/) 至收到这些复制文件的管理节点中
...
1. [SSH 至您的代理节点之一。](/zh/1.11/administering-clusters/sshcluster/)
