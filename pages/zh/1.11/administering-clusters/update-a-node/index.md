...
* [已安装和配置 SSH](/zh/1.11/administering-clusters/sshcluster/)。这是通过手动终止代理来删除节点所需的。
* 可访问 [Admin Router 权限](/zh/1.11/overview/architecture/components/#admin-router)。
...
1. [SSH 至代理节点](/zh/1.11/administering-clusters/sshcluster/)。
1. 停止代理。
