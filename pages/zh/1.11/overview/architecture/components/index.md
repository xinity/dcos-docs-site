...
![Mesosphere DC/OS Enterprise 组件](/zh/1.11/img/dcos-components-1.11-portrait.png)
...
- [文档](/zh/1.11/administering-clusters/backup-and-restore/)
- [API 参考](/zh/1.11/administering-clusters/backup-and-restore/backup-restore-api/)
...
- [文档](/zh/1.11/deploying-services/)
- [来源](https://github.com/mesosphere/marathon)
- [API 参考](/zh/1.11/deploying-services/marathon-api/)
...
- [API 参考](/zh/1.11/monitoring/#system-health-http-api-endpoint)
...
- [API 参考](/zh/1.11/monitoring/logging/logging-api/)
...
- [API 参考](/zh/1.11/metrics/metrics-api/)

<a name="dcos-signal"></a>

## DC/OS 信号

DC/OS 信号服务报告群集遥测和分析，以帮助改进 DC/OS。管理员在安装时可以 [不选择遥测](zh/1.11/install/production/deploying-dcos/opt-out/#telemetry)。
...
- [API 参考](/zh/1.11/networking/mesos-dns/mesos-dns-api/)
...
- [API 参考](/zh/1.11/deploying-services/package-api/)
...
- [API 参考](/zh/1.11/administering-clusters/component-management/)
...
- [文档](/zh/1.11/security/)
- [API 参考](/zh/1.11/security/ent/iam-api/)
...
- [文档](/zh/1.11/security/ent/tls-ssl/)
- [API 参考](/zh/1.11/security/ent/tls-ssl/ca-api/)
...
- [文档](/zh/1.11/security/ent/secrets/)
- [API 参考](/zh/1.11/security/ent/secrets/secrets-api/)
