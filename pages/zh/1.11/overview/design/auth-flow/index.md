...
1. 在浏览器中打开群集首页 URL。
2. 如果您有有效的 [认证令牌](/zh/1.11/security/oss/managing-authentication#log-in-cli) cookie（由 Admin Router 检查），则可以转到群集首页。如果没有，您将重定向至登录页面。
