...
- Prerequisites - This roles handles all of the [requirements to run DC/OS](/mesosphere/dcos/1.14/installing/production/system-requirements/#software-prerequisites).
